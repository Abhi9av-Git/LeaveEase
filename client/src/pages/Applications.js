...
import { FaFileAlt, FaPlus, FaClock, FaCheckCircle, FaTimesCircle, FaFilter, FaSearch } from 'react-icons/fa';
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-gray-600">
              View and manage all your leave and outpass applications
            </p>
          </div>
          <Link
            to="/applications/new"
                  ...
                  {currentApplications.map((application) => (
                    <tr key={application._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {application.applicationType === 'outpass' ? formatDateTime(application.initialTime) : formatDate(application.journeyDate)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {application.applicationType === 'outpass' ? formatDateTime(application.expectedReturnTime) : formatDate(application.returnDate)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
